...
output of the normalized frontogenesis function sorted by relative vorticity>1,
which indicates an active front is present.See mnum_fgf_TXLA.ipynb for relevant 
theory and explanation of the functions.
"""
#Packages
import numpy as np
import xgcm
...
# Save
fp_pdf.to_netcdf('txla_nFGF_pdf_par_june_10_16_2010.nc')
fc_pdf.to_netcdf('txla_nFGF_pdf_chi_june_10_16_2010.nc')